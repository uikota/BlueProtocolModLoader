...
namespace UE4
{
	...
	public:
		...
		{
			return GameProfile::Instance.IsUsingFChunkedFixedUObjectArray;
		}
	...
	public:
		...
		{
			if (GameProfile::Instance.bIsDefaultObjectArrayed == true)
			{
		...
		inline UObject* CreateDefaultObject()
		{
			...
			{
				return reinterpret_cast<UObject * (*)(UClass*)>(this, GameProfile::Instance.CreateDefaultObject)(this);
			}
		}
