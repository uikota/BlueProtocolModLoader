...
namespace UE4
{
	...
	{
		auto Name = *reinterpret_cast<FName*>((byte*)this + GameProfile::Instance.defs.UObject.Name);
	...
	{ 
		return Read<int32_t>((byte*)this + GameProfile::Instance.defs.UObject.Index);
	};

	UClass* UObject::GetClass() const 
	{ 
		return Read<class UClass*>((byte*)this + GameProfile::Instance.defs.UObject.Class);
	};

	UObject* UObject::GetOuter() const 
	{ 
		return Read<UObject*>((byte*)this + GameProfile::Instance.defs.UObject.Outer);
	};
	...
	{
		return reinterpret_cast<UObject * (__fastcall*)(class UClass*, UObject*, const wchar_t*, const wchar_t*, unsigned int, void*, bool)>(GameProfile::Instance.StaticLoadObject)(uclass, InOuter, InName, Filename, LoadFlags, Sandbox, bAllowObjectReconciliation);
	}
	...
	{
		if (GameProfile::Instance.StaticConstructObject_Internal)
		{
			if (GameProfile::Instance.IsUsingUpdatedStaticConstruct)
			{
				...
				return reinterpret_cast<UObject * (__fastcall*)(const FStaticConstructObjectParameters*)>(GameProfile::Instance.StaticConstructObject_Internal)(&StaticConstructObjectParameters);
			}
			else
			{
				return reinterpret_cast<UObject * (__fastcall*)(UClass*, UObject*, FName, unsigned int, unsigned int, UObject*, bool, void*, bool)>(GameProfile::Instance.StaticConstructObject_Internal)(Class, InOuter, Name, SetFlags, InternalSetFlags, Template, bCopyTransientsFromClassDefaults, InstanceGraph, bAssumeTemplateIsArchetype);
			}
		}
		else
		{
	...
	{
		return reinterpret_cast<bool (*)(UE4::UObject*, const wchar_t*, void*, UE4::UObject*, bool)>(GameProfile::Instance.CallFunctionByNameWithArguments)(this, Str, Ar, Executor, bForceCallWithNonExec);
	}
	...
	{ 
		return Read<UField*>((byte*)this + GameProfile::Instance.defs.UField.Next);
	};
	...
	{ 
		return Read<UStruct*>((byte*)this + GameProfile::Instance.defs.UStruct.SuperStruct);
	};

	UField* UStruct::GetChildren() const 
	{ 
		return Read<UField*>((byte*)this + GameProfile::Instance.defs.UStruct.Children);
	};

	int32_t UStruct::GetPropertySize() const 
	{ 
		return Read<int32_t>((byte*)this + GameProfile::Instance.defs.UStruct.PropertiesSize);
	};
	...
	int32_t UFunction::GetFunctionFlags() const { return Read<int32_t>((byte*)this + GameProfile::Instance.defs.UFunction.FunctionFlags); };
	void* UFunction::GetFunction() const { return Read<void*>((byte*)this + GameProfile::Instance.defs.UFunction.Func); };
	...
	{
		return Read<int32_t>((byte*)this + GameProfile::Instance.defs.Property.ArrayDim);
	};
	/*
	...
	*/
	...
	{
		return Read<int32_t>((byte*)this + GameProfile::Instance.defs.Property.Offset);
	};
	...
	{
		return Read<class FField*>((byte*)this + GameProfile::Instance.defs.FField.Next);
	};

	std::string FField::GetName() const
	{
		auto Name = *reinterpret_cast<FName*>((byte*)this + GameProfile::Instance.defs.FField.Name);
	...
	{
		return reinterpret_cast<AActor * (*)(UWorld*, UClass*, const FTransform*, const FActorSpawnParameters*)>(GameProfile::Instance.SpawnActorFTrans)(this, uclass, transform, params);
	}
